...
### `webNavigation`
**Why needed:** To detect when page navigation completes and handle single-page application (SPA) navigation. Ensures content extraction waits for the page to fully load.

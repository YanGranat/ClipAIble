...
export const CONFIG = {
  ...
  // Logging
  LOG_LEVEL: 0,                   // Log level: 0=DEBUG, 1=INFO, 2=WARN, 3=ERROR (default: ERROR for production)
  VERBOSE_LOGGING: true,          // Enable verbose logging for detailed debugging (increases log volume significantly)

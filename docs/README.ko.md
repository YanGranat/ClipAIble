...
![버전](https://img.shields.io/badge/버전-2.7.0-blue)
...
- **여러 제공업체 지원**: OpenAI GPT, Google Gemini, Anthropic Claude
- **지능형 감지**: 기사의 주요 내용을 찾고 자동으로 불필요한 요소 제거
- **구조 보존**: 제목, 이미지, 코드 블록, 테이블, 각주

### 🎧 오디오 내보내기
- **2개의 TTS 제공업체**: OpenAI TTS 및 ElevenLabs
- **20개 이상의 음성**: 11개의 OpenAI 음성 + 9개의 ElevenLabs 음성
- **속도 조절**: 0.5x ~ 2.0x
- **다국어 발음**: 각 언어에 맞는 올바른 발음
- **지능형 텍스트 정리**: AI가 URL, 코드 및 비음성 콘텐츠 제거

### 🌍 번역
- **11개 언어**: EN, RU, UK, DE, FR, ES, IT, PT, ZH, JA, KO
...
### 🔒 보안
- **API 키 암호화** AES-256-GCM (OpenAI, Claude, Gemini, ElevenLabs)
...
|----------|-----------|--------|-------------|
| **OpenAI** | 일반 사용, 오디오 내보내기 | ✅ | ❌ |
| **Gemini** | 빠른 추출, 이미지 번역 | ❌ | ✅ |
| **Claude** | 긴 기사, 복잡한 페이지 | ❌ | ❌ |

**권장 사항:** 모든 기능 (추출 + 오디오)을 얻기 위해 OpenAI로 시작하세요.
